...
{
    // Les DTOs de résultat (SourceMutation, AmbiguityAlternative, AmbiguitySpot,
    // AmbiguityMatch, AmbiguityResult) ont été déplacés dans AmbiguityModel.cs
    // (palier 0 du retrait Lattice, ADR 2026-06-03) — ils sont partagés avec v2
    // et doivent survivre à la suppression de ce générateur legacy.
